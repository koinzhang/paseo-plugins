...
- 状态：已实现（直方图段圆角被 [055](../055-creations-day-gradient/) 取代）
- 日期：2026-09-20
- 依赖：050（KPI 6 格与 Top provider / Top model 口径）、051（provider 堆叠直方图）
- 修订：[055](../055-creations-day-gradient/) 把日柱改为整块软渐变，G3 段圆角规则不再适用
...
| G3 | 直方图堆叠柱：**仅最上方一段**带 3px 上圆角，其余段与接缝为直角（**055 起改为整柱软渐变**，本条不再适用） |
