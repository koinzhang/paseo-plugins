...
[plugin project](quickstart.md), then choose where to share it:
...
See the [project reference](reference-project.md#project-files) for entry points and runtime boundaries.
...
declare a [preparation command](reference-ops.md#cli-reference).
