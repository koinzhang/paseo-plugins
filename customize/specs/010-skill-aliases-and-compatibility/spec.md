...
- Expose compatibility support and effective on/off/unknown state in scan results. Show a leading icon beside Provider for every provider scanning cross-agent skill roots. Distinguish off and unknown states in the icon's accessible label and visual style.
