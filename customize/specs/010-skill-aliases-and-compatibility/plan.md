...
3. Gate Cursor/OpenCode external skill routes when compatibility is off. Render a leading status icon for all providers with cross-agent skill roots. Derive mechanism copy from the scan state.
